...
# buildozer.
android.accept_sdk_license = True  # <--- ВОТ ЭТО САМОЕ ГЛАВНОЕ!
...
# Usage example : android.manifest_placeholders = { 'myCustomPlaceholder': 'myCustomValue' }
...
android.release_artifact = apk  # <--- ВАЖНО: СОБИРАЕМ APK
